...
tmp<volScalarField>
kEpsilon_BCS5_kande<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
void kEpsilon_BCS5_kande<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kEpsilon_BCS5_kande<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kEpsilon_BCS5_kande<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class BasicMomentumTransportModel>
kEpsilon_BCS5_kande<BasicMomentumTransportModel>::kEpsilon_BCS5_kande
(
...
template<class BasicMomentumTransportModel>
bool kEpsilon_BCS5_kande<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void kEpsilon_BCS5_kande<BasicMomentumTransportModel>::correct()
{
