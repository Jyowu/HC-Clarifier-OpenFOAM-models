...
buoyantKEpsilonCC<BasicMomentumTransportModel>::buoyantKEpsilonCC
(
...
template<class BasicMomentumTransportModel>
bool buoyantKEpsilonCC<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField>
buoyantKEpsilonCC<BasicMomentumTransportModel>::Gcoef() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
buoyantKEpsilonCC<BasicMomentumTransportModel>::kSource() const
{
    const uniformDimensionedVectorField& g =
        this->mesh_.objectRegistry::template
        lookupObject<uniformDimensionedVectorField>("g");
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
buoyantKEpsilonCC<BasicMomentumTransportModel>::epsilonSource() const
{
    const uniformDimensionedVectorField& g =
        this->mesh_.objectRegistry::template
        lookupObject<uniformDimensionedVectorField>("g");
