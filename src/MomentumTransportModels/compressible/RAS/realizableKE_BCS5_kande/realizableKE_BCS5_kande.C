...
void realizableKE_BCS5_kande<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> realizableKE_BCS5_kande<BasicMomentumTransportModel>::rCmu
(
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS5_kande<BasicMomentumTransportModel>::correctNut
(
    const volTensorField& gradU,
    const volScalarField& S2,
    const volScalarField& magS
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS5_kande<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS5_kande<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
realizableKE_BCS5_kande<BasicMomentumTransportModel>::realizableKE_BCS5_kande
(
...
template<class BasicMomentumTransportModel>
bool realizableKE_BCS5_kande<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS5_kande<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    if (curvatureSwirlTools_.active())
    {
        ...
        curvatureSwirlData5 swirlData = curvatureSwirlTools_.evaluate
        (
            U,
            gradU,
            rho,
