...
void kOmega_BCS5_kande<BasicMomentumTransportModel>::boundOmega()
{
...
template<class BasicMomentumTransportModel>
void kOmega_BCS5_kande<BasicMomentumTransportModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmega_BCS5_kande<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmega_BCS5_kande<BasicMomentumTransportModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class BasicMomentumTransportModel>
kOmega_BCS5_kande<BasicMomentumTransportModel>::kOmega_BCS5_kande
(
...
template<class BasicMomentumTransportModel>
bool kOmega_BCS5_kande<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void kOmega_BCS5_kande<BasicMomentumTransportModel>::correct()
{
