...
tmp<volScalarField>
RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class BasicMomentumTransportModel>
RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::RNGkEpsilon_BCS5_kande
(
...
template<class BasicMomentumTransportModel>
bool RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_BCS5_kande<BasicMomentumTransportModel>::correct()
{
