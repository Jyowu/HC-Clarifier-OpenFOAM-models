...
void realizableKE_BCS<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> realizableKE_BCS<BasicMomentumTransportModel>::rCmu
(
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS<BasicMomentumTransportModel>::correctNut
(
    const volTensorField& gradU,
    const volScalarField& S2,
    const volScalarField& magS
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> realizableKE_BCS<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
realizableKE_BCS<BasicMomentumTransportModel>::realizableKE_BCS
(
...
template<class BasicMomentumTransportModel>
bool realizableKE_BCS<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
